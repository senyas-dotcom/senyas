...
<head>
  ...
  <title>Famy Senyas App Users</title>
...
<!-- Start wrapper-->
 <div id="wrapper">
   ...
   <?php
     include('../resources/views/ActionCenter/nav/navmguser.php');
   ?>
...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <!--Start Content -->
      <div id="username" style="display:none">{{$current_user}}</div>
 ...
 <!-- simplebar js -->
  ...
  <script src="/js/ActionCenter/appuser.js"></script>
