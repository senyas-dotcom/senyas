<!--Start sidebar-wrapper-->
   ...
   <ul class="sidebar-menu do-nicescrol">
      ...
      <li class="dashtreme-border ">
        <a href="/">
          <i class="zmdi zmdi-center-focus-strong"></i> <span>Command Center</span>
        </a>
      </li>
       ...
       <li class="dropdown-item user-details">
        <a href="javaScript:void();">
           <div class="media">
            ...
            <h6 class="mt-2 user-title">Command Center</h6>
            <p class="user-subtitle" id="current-user">Famy Senyas</p>
            </div>
           </div>
          </a>
        </li>
