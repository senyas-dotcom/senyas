...
<head>
  ...
  <title>Famy Senyas Admin Update apk</title>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header">Note: Please upload senyas apk only. Thanks!</div>
            <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          <div>
                            ...
                            <form action="{{ route('auth.uploadapk', 'famy') }}"  id="form" method="post" enctype="multipart/form-data" target="iframe">
                              {{ csrf_field() }}
