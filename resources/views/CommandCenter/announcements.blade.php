...
<head>
  ...
  <title>Famy Senyas Info Blast</title>
    ...
    <div class="container-fluid">
      ...
      <div class="row pt-2 pb-2">
         <div class="col-sm-9">
           ...
           <ol class="breadcrumb">
             <li class="breadcrumb-item">Famy Senyas</a></li>
                ...
                <div class="col-lg-12 col-md-12">
                  ...
                  <div class="card mt-3 shadow-none">
                    <div class="list-group shadow-none">
                      <a id="inbox" href="#" class="list-group-item active"><i class="fa fa-inbox mr-2"></i> Inbox (0)</a>
                      <a id="attachments" href="#" class="list-group-item"><i class="fa fa-paperclip mr-2"></i> Attachments (0)</a>
                      <a id="delete" href="#" class="list-group-item"><i class="fa fa-trash-o mr-2"></i> Trash</a>
                    </div>
                  </div>
                </div>
                <!-- End left side bar -->
            ...
            <div class="row">
              <div class="col-lg-8">
                <div class="btn-group mr-1" style="position:relative; left: 13px">
                    <a id="restore" href="#" class="list-group-item" disabled><i class="zmdi zmdi-time-restore-setting"></i></a>
                    <a id="trash" href="#" class="list-group-item"><i class="fa fa-trash-o"></i></a>
                </div>
              </div>
            </div>
