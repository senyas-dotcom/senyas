...
<head>
  ...
  <title>Famy Senyas Dashoard</title>
    ...
    <div id="qrModal" class="modal fade" style="display: none;" aria-hidden="true" role="dialog">
      <div class="modal-dialog modal-sm modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-header">
            <h5 class="modal-title noselect">Famy Senyas APK Download</h5>
            <button type="button" data-dismiss="modal" aria-label="Close" class="close">
              <span aria-hidden="true" style="color: white">x</span>
            </button>
          </div>
          ...
          <div class="modal-body" id="row">
            <img src="/img/famy_qr.png" alt="" class="img-fluid rounded">
          </div>

          <div class="modal-footer">
            <a href="/img/famy_qr.png" download class="btn btn-info">Download QR code</a>
          </div>
          </form>
        </div>
